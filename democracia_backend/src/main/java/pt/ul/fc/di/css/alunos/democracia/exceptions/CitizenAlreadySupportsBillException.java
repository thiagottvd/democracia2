...
public class CitizenAlreadySupportsBillException extends ApplicationException {
  ...
  /**
   * Constructs a new CitizenAlreadySupportsBillException with the specified error message and a
   * reference to the lower-level exception that caused this exception.
   *
   * @param message the error message to be associated with the exception.
