...
INSERT INTO bill(id, description, expiration_date, file_data, num_supporters, status, title, delegate_id, theme_id) VALUES(10, 'Mock - Bill 10 - PDF BYTES = NULL', NOW(), NULL, 0, 'OPEN', 'Criar uma Comissão Nacional para Debates Eleitorais e alterar a Lei da cobertura eleitoral', 1, 4);
INSERT INTO bill(id, description, expiration_date, file_data, num_supporters, status, title, delegate_id, theme_id) VALUES(20, 'Mock - Bill 20 - PDF BYTES = NULL', NOW(), NULL, 8273, 'OPEN', 'Indicador de Risco em caso de Sismo', 3, 3);
INSERT INTO bill(id, description, expiration_date, file_data, num_supporters, status, title, delegate_id, theme_id) VALUES(30, 'Mock - Bill 30 - PDF BYTES = NULL', NOW(), NULL, 0, 'CLOSED', 'Criação da Lei 4093 $2A', 1, 1);
